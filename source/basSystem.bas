...
Private Sub exportCode()
    ...
    For Each vcomSource In Application.VBE.VBProjects("traffic_generator").VBComponents
        Select Case vcomSource.Type
            ...
            Case Else
                strSuffix = "txt"
        End Select
        If Left(vcomSource.Name, 3) <> "wsh" Then
        ...
        Else
            basSystem.log "ignore " & vcomSource.Name & "." & strSuffix
        End If
    Next
    Exit Sub
